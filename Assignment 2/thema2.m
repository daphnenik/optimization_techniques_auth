...
% Steepest Descent method for every initial point (x1,y1) and for every gk case
for i = 1:3
    ...
    for j = 1:3 %3 cases for gk: const, minimizes f(xk+gk*dk), armijo
        switch j
            case 1 %gk const
                ...
                %plot the results
                figure();
                contourf(x_plot,y_plot,fxy(x_plot,y_plot),10,'--');
                title(['2D filled contour plot of f, gk const,',' x1 = ',num2str(x1),' y1 = ',num2str(y1)]);
                hold on;
                plot(x,y,'red');
                scatter(x,y,'red');
                xlabel('x axis');
                ...
                k = 1:length(x);
                plot(k,fxy(x,y),'k');
                title(['f(x,y) values for different k, const gk,',' x1 = ',num2str(x1),' y1 = ',num2str(y1)]);
                hold on;
            ...
            case 2 %gk that minimizes f(xk+gk*dk)
                ...
                figure();
                contourf(x_plot,y_plot,fxy(x_plot,y_plot),10,'--');
                title(['2D filled contour plot of f, gk that minimizes f(xk+gk*dk),',' x1 = ',num2str(x1),' y1 = ',num2str(y1)]);
                hold on;
                plot(x,y,'red');
                scatter(x,y,'red');
                xlabel('x axis');
            ...
            case 3 %gk armijo
                ...
                figure();
                contourf(x_plot,y_plot,fxy(x_plot,y_plot),10,'--');
                title(['2D filled contour plot of f, gk armijo,',' x1 = ',num2str(x1),' y1 = ',num2str(y1)]);
                hold on;
                plot(x,y,'red');
                scatter(x,y,'red');
                xlabel('x axis');
                ...
                k = 1:length(x);
                plot(k,fxy(x,y),'k');
                title(['f(x,y) values for different k, gk from armijo,',' x1 = ',num2str(x1),' y1 = ',num2str(y1)]);
                hold on;
                scatter(k,fxy(x,y),'red');
                xlabel('k');
                ylabel('f(xk,yk)');
...
% Steepest Descent method with constant gk
...
% Steepest Descent method with gk that minimizes f(xk+gk*dk)
...
% Steepest Descent method with gk from armijo
